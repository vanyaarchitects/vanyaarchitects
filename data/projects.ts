...
export const projects: Project[] = [
  {
    ...
    area: "420 m²",
    year: "2024",
    description: "Perched on the rugged coastline of northern Denmark, Villa Sands is a celebration of light, concrete, and the sea. The building composition features overlapping horizontal planes of board-marked concrete, intersected by frameless glass walls that dissolve the boundary between the living spaces and the maritime horizon. The interior layout uses raw oak, natural linen, and sand-colored travertine, fostering a calm, sanctuary-like atmosphere inspired by Scandinavian minimalism.",
  ...
  },
  {
    ...
    area: "850 m²",
    year: "2023",
    description: "The Aura Pavilion is a wellness resort lounge designed in collaboration with local artisans. Tucked into a bamboo forest, the structure utilizes traditional Japanese timber framing integrated with modern steel joints. A central silent reflection pool mirrors the sky and forest canopy. Floating wooden decks, screen walls, and sliding panels permit natural ventilation, while the scent of locally harvested Hinoki cypress wood completes the deeply restorative sensory experience.",
  ...
  },
  {
    ...
    area: "4,500 m²",
    year: "2025",
    description: "Commanding views over the Oslo Fjord, the Nordic Museum houses galleries for contemporary sculpture and community halls. Built with locally quarried light granite and sweeping laminated wood curves, the museum's ceiling features custom sculptural skylights that funnel northern daylight into the galleries, forming shifting patterns of shadow and light that naturally illuminate the artwork below.",
